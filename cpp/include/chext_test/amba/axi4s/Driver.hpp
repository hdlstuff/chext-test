...
template<
    ...
    bool HAS_KEEP = true,
    bool HAS_LAST = true>
struct Master : elastic::Source<Signals<DATA_WIDTH, ID_WIDTH, DEST_WIDTH, USER_WIDTH, HAS_STROBE, HAS_KEEP, HAS_LAST>> {
...
template<
    ...
    bool HAS_KEEP = true,
    bool HAS_LAST = true>
struct Slave : elastic::Sink<Signals<DATA_WIDTH, ID_WIDTH, DEST_WIDTH, USER_WIDTH, HAS_STROBE, HAS_KEEP, HAS_LAST>> {
    using SignalsT = Signals<DATA_WIDTH, ID_WIDTH, DEST_WIDTH, USER_WIDTH, HAS_STROBE, HAS_KEEP, HAS_LAST>;
    using PacketT = typename SignalsT::value_type;
